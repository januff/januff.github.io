...
export const getLayoutTopSidenavState = createSelector(getLayoutState, fromLayout.getTopSidenavState);

export const getLayoutBottomSidenavState = createSelector(getLayoutState, fromLayout.getBottomSidenavState);
